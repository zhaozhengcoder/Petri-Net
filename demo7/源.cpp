...
public:
	...
	void print_delay(Graph & g) {
		...
		//for (auto it = g.pout[1].contain.begin(); it != g.pout[1].contain.end(); it++) {
		//	delay_time_sum1+= (*it)->get_delay_time();
		//}

		//float delay_time_sum2 = 0.0;
		////g.pout[5].contain;
		//for (auto it = g.pout[5].contain.begin(); it != g.pout[5].contain.end(); it++) {
		//	delay_time_sum2 += (*it)->get_delay_time();
		//}

		//cout << "phase 1 的延时 ： " << delay_time_sum1 << endl;
		//cout << "phase 2 的延时 ： " << delay_time_sum2 << endl;
		...
		cout << "phase 1 dir=0 的延时 ： " << delay_time_sum1 <<"  车辆数 ： "<< car_num1 << "  平均延时： " << delay_time_sum1 / car_num1 << endl;
		cout << "phase 1 dir=1 的延时 ： " << delay_time_sum2 <<"  车辆数 ： "<< car_num2 << "  平均延时： " << delay_time_sum2 / car_num2 << endl;
		...
		cout << "phase 2 dir=0 的延时 ： " << delay_time_sum3 << "  车辆数 ： " << car_num3 << "  平均延时： " << delay_time_sum3 / car_num3 << endl;
		cout << "phase 2 dir=1 的延时 ： " << delay_time_sum4 << "  车辆数 ： " << car_num4 << "  平均延时： " << delay_time_sum4 / car_num4 << endl;
		...
		cout << "phase 3 dir=0 的延时 ： " << delay_time_sum5<< "  车辆数 ： " << car_num5 << "  平均延时： " << delay_time_sum5 / car_num5 << endl;
		cout << "phase 3 dir=1 的延时 ： " << delay_time_sum6 << "  车辆数 ： " << car_num6 << "  平均延时： " << delay_time_sum6 / car_num6 << endl;
		...
		cout << "phase 4 dir=0 的延时 ： " << delay_time_sum7<< "  车辆数 ： " << car_num7<<"  平均延时： " << delay_time_sum7/car_num7 << endl;
		cout << "phase 4 dir=1 的延时 ： " << delay_time_sum8<< "  车辆数 ： " << car_num8 <<"  平均延时： "<< delay_time_sum8 /car_num8<< endl;
